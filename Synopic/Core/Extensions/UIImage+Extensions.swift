...
/// Super cool approach to retrieving average color of UIImage found https://christianselig.com/2021/04/efficient-average-color/
/// Approach is generally more efficient than going pixel by pixel as most appraoches do

extension UIImage {
  var averageUIColor: UIColor? { findAverageColor(algorithm: .simple) }
