...
public extension Publisher {
  ...
  internal func assign<Root: AnyObject>(
    to keyPath: ReferenceWritableKeyPath<Root, Output>,
    on root: Root
  ) -> AnyCancellable { self.sink { [weak root] in root?[keyPath: keyPath] = $0 } }
...
>>>>>>> c9af2cb4c9ce28eae5109f046cf1da6cdb93b3c4
  ...
  internal func withLatestFromUnretained<Other: Publisher, Result>(
    _ other: Other,
  ...
  /// .withLatestFromFix(_:) in CombineExt is leaky for long-lived streams: https://github.com/CombineCommunity/CombineExt/issues/87
  /// This version fixes the stream issue (see comment on 8/6/2021 by freak4pc) https://gist.github.com/freak4pc/8d46ea6a6f5e5902c3fb5eba440a55c3
  internal func withLatestFromUnretained<Other: Publisher>(_ other: Other)
